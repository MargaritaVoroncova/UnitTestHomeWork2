...
*/
    ...
    void priceCartIsCorrectCalculated() {
        ...
        // Assert (Проверка)
        double expectedTotalPrice = 170 + 250 + 200 + 150 + 15;
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        cart.addProductToCartByID(productId);
        // Act
        double initialTotalPrice = cart.getTotalPrice();
        cart.removeProductByID(productId);
        double recalculatedTotalPrice = cart.getTotalPrice();
        // Assert
        Assertions.assertNotEquals(initialTotalPrice, recalculatedTotalPrice);
    }
